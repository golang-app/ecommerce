...
// As of the customer/admin split, the must_change_password gate is admin-only
// — there is no equivalent forced-reset state on the customer side, so this
// helper is now a single happy-path check.
